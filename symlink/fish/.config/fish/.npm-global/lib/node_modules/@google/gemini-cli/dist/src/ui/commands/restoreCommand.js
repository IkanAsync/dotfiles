...
import { z } from 'zod';
import { formatCheckpointDisplayList, getToolCallDataSchema, getTruncatedCheckpointNames, performRestore, } from '@google/gemini-cli-core';
...
async function restoreAction(context, args) {
    ...
    try {
        ...
        const toolCallData = parseResult.data;

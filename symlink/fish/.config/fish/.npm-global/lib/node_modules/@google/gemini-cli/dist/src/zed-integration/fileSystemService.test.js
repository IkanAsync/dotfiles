...
describe('AcpFileSystemService', () => {
    ...
    describe('readTextFile', () => {
        it.each([
            ...
            service = new AcpFileSystemService(mockClient, 'session-1', { readTextFile: capability, writeTextFile: true }, mockFallback);
            setup();
    ...
    describe('writeTextFile', () => {
        it.each([
            ...
            service = new AcpFileSystemService(mockClient, 'session-1', { writeTextFile: capability, readTextFile: true }, mockFallback);
